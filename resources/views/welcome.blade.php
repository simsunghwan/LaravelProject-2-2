  ...
  <div
    ...
    <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
      ...
      <a href="{{ url('/dashboard') }}"
        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">대시보드</a>
      @else
      <a href="{{ route('login') }}"
      ...
      <div class="mt-16">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          <a href="{{ route('login') }}"
            ...
            <div>
              <div class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                <img src="{{ asset('images/login_user.svg') }}" alt="SVG Image">
          ...
          <a href="{{ route('register') }}"
            ...
            <div>
              <div class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                <img src="{{ asset('images/register_user.svg') }}" alt="SVG Image">
              </div>
